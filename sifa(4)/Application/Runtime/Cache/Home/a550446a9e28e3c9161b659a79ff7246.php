...
<body>
			...
			<ul>
				<li class="jbxx">
					<a href="<?php echo U('Jbxx/jbxx');?>" target="_self">
						<img src="/sifa(4)/Public/images/jbxx.png" width="55" height="55" /><font color='#FFF'>鉴定录入</font>
					</a>
				</li>
				<li class="bgcx">
					<a href="<?php echo U('Baogao/baogao');?>" target="_self">
						<img src="/sifa(4)/Public/images/bgcx_hover.png" width="55" height="55" />鉴定查询
					</a>
				</li>
				<li class="sys">
	...
	<div class="right">
		<iframe class="iframe" src="<?php echo U('Baogao/baogaoiframe');?>">
