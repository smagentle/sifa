...
<div style="display:none;">
 ...
 class word{ function start(){ ob_start(); print'<html xmlns:o="urn:schemas-microsoft-com:office:office" 
	...
	<div style="width:100%;font-size:17.5px;font-family:仿宋_GB2312;line-height:3em;">
		...
		<table border="0" cellspacing="0" cellpadding="0" style="width:100%;line-height:3em;font-size:19px;font-family:仿宋_GB2312;">
			<tr>
				<td style="width:55%;">
					<br>
					<span style="font-family:黑体;font-size:20px;">一、基本情况</span>
					<br>
					<span style="font-family:黑体;font-size:20px;">委 托 方：</span>
					<?php echo ($jieguo[0][wtf]); ?><br>
					<span style="font-family:黑体;font-size:20px;">委托事项：</span>
					<?php echo ($jieguo[0][wtsx]); ?><br>
					<span style="font-family:黑体;font-size:20px;">受理日期：</span>
					<?php echo ($jieguo[0][slrq]); ?><br>
					<span style="font-family:黑体;font-size:20px;">鉴定材料：</span>
				</td>
				<td style="text-align:center;width:45%;">
					<font size="-1">（此处未加盖钢印无效）</font><br/>
		...
		<div style="line-height:3em;">
			...
			二、检案摘要	
				...
				<?php  $jazt=str_replace("Public","http://localhost/sifa(4)/Public",$jieguo[0][jazy]); $jazy=strip_tags($jazt,'<br>'); echo $jazy; ?><br>
			<span style="font-family:黑体;font-size:20px;">
				三、检验过程
			</span><br>
				<?php
 $jygc1=strip_tags($jieguo[0][jygc1]); $jygc1=trim($jygc1); echo '&nbsp;&nbsp;'.$jygc1.'<br>'; $jygc2=strip_tags($jieguo[0][jygc2]); $jygc2=trim($jygc2); echo '&nbsp;&nbsp;'.$jygc2.'<br>'; $jygc3=strip_tags($jieguo[0][jygc3]); $jygc3=trim($jygc3); echo '&nbsp;&nbsp;'.$jygc3.'<br>'; ?> 
 ...
 $fxsm2=strip_tags($jieguo[0][fxsm2]); $fxsm2=trim($fxsm2); echo '&nbsp;&nbsp;'.$fxsm2; ?>
			...
			<span style="font-family:黑体;font-size:20px;">
				...
				&nbsp;&nbsp;被鉴定人<?php echo ($sqs[0][name]); echo ($sqs[0][gjssbw1]); ?>损伤为<?php echo ($jieguo[0][fxsm6]); ?>。<br>
