...
<div id="决定书" class="jds">
    <form action="<?php echo U('Jbxx/index',array('id'=>'jds'));?>" method="post">
        <table>
            <tr> 
        ...
        <table>
            ...
            <tr>
                <td>
                    序通则》第十一条、第十二条、第十六条，决定予以受理进行<input type="text" name="jds[bw]" style="border-bottom:1px solid #000000;width:60px;" value='<?php
