...
<div id="content">
		...
		<div class="table-ji">
			<table class="bg">
				<tr>
					...
					<td><input type="text" name="wts[lxrname]" id="vcode3" value="<?php echo ($wts[0][lxrname]); ?>" onfocus="down()"/></td>
				</tr>
				<tr>
					<td id="gdwidth">联系地址</td>
					<td><input type="text" name="wts[lxaddress]" value="<?php echo ($wts[0][lxaddress]); ?>"/></td>
					<td id="gdwidth3">联系电话</td>
					<td><input type="text" name="wts[lxphone]" id="vcode4" value="<?php echo ($wts[0][lxphone]); ?>" onfocus="down()"/></td>
				</tr>
				<tr>
			...
			<table class="bg2">
				...
				<tr>
					...
					<td colspan="3">由<input type="text" name="wts[wtrname1]" id="vcode2" value="<?php echo ($wts[0][wtrname1]); ?>" />委托我中心要求为<?php echo ($sqs[0][name]); ?>进行<?php echo ($a[0][name]); echo ($b[0][name]); ?></td>
				</tr>
				<tr>
 ...
 $jd = D('weituos'); $res = $jd -> field('cxjd') -> where("bianhao = '$id'") -> select(); if($res[0][cxjd] == 0){ echo "是"; }else{ echo "否"; } ?>
				...
				<tr height="200">
					...
					<td colspan="3">
						<textarea name="wts[jdfy]" style="outline:none;" rows="5" cols="67%" onmousedown="s(event,this)"><?php echo ($wts[0][jdfy]); ?></textarea>
					</td>
				</tr>
				<tr id="feiyong">
 ...
 $yj = D('weituos'); $res = $yj -> field('fsfs') -> select(); if($res[0][fsfs] == 0){ ?>
						...
						<?php
									...
									<label><input type="radio" name="wts[fsfs]" value="0" disabled = "disabled" />自取</label><br /><br />
									<label><input type="radio" name="wts[fsfs]" value="1" disabled = "disabled" />邮寄地址：<input type="text" name="wts[youji]" value="<?php echo ($wts[0][youji]); ?>"/></label><br /><br />
  ...
  <div id="接谈笔录">
  	<form action="<?php echo U('Jbxx/index',array('id'=>'jietanbl'));?>" method="post">
		...
		<p style="background:red;"><?php echo ($wts[0][jazy]); ?></p>
